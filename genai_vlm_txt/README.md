...
.\build\Release\genai_vlm_txt.exe -m \\path\\to\\Qwen3-VL-4B -d GPU  --test_mode memory
.\build\Release\genai_vlm_txt.exe -m \\path\\to\\Qwen3-VL-4B -d GPU  --test_mode performance
.\build\Release\genai_vlm_txt.exe -m \\path\\to\\Qwen3-VL-4B -lora_adapter \\path\\to\\adapter_model.safetensors -d GPU --test_mode lora_memory
.\build\Release\genai_vlm_txt.exe -m \\path\\to\\Qwen3-VL-4B -lora_adapter \\path\\to\\adapter_model.safetensors -d GPU --test_mode lora_performance
